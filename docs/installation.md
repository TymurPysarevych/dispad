...
2. Open `DispadClient/DispadClient.xcodeproj`.
3. Connect your iPad by USB-C and trust the Mac when prompted on the iPad.
4. Select your iPad as the run destination.
5. In the project settings → Signing & Capabilities:
...
6. Hit Run.
7. On the iPad: Settings → General → VPN & Device Management → tap your Apple ID under "Developer App" → Trust.
